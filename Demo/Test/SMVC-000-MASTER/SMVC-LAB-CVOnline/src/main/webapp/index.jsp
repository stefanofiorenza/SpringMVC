...
<div id="menu">
	<ul>
		...
		<li class="current_page_item"><a href="#">Register CV</a></li>
		<li><a href="#">Search CV</a></li>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><a href="#">Benvenuto in collaboration</a>
				</h2>
			<div class="entry">
			...
			<form action="prova.php">
				<table width="383" border="0">
                  <tr>
                    ...
                    <td width="156"><input maxlength="16" size="25" name="username" /></td>
                  </tr>
                  <tr>
                    <td>Password</td>
                    <td><input maxlength="16" size="25" name="username2" /></td>
                  </tr>
                  <tr>
                    <td>Verifica Password:</td>
                    <td><input maxlength="16" size="25" name="username3" /></td>
                  </tr>
                  <tr>
                    <td>Nome:</td>
                    <td><input maxlength="16" size="25" name="username4" /></td>
                  </tr>
                  <tr>
                    <td>Cognome:</td>
                    <td><input maxlength="16" size="25" name="username5" /></td>
                  </tr>
                  <tr>
                    <td>Cod. Fiscale:</td>
                    <td><input maxlength="16" size="25" name="username6" /></td>
                  </tr>
                  <tr>
                    <td>Sesso</td>
                  ...
                  <tr>
                    <td>Email</td>
                    <td><input maxlength="16" size="25" name="username7" /></td>
                  </tr>
                  <tr>
                    <td>Conferma Email </td>
                    <td><input maxlength="16" size="25" name="username8" /></td>
                  </tr>
                  <tr>
                    <td>Telefono</td>
                    <td><input maxlength="16" size="25" name="username9" /></td>
                  </tr>
                  <tr>
                    <td>Fax</td>
                    <td><input maxlength="16" size="25" name="username10" /></td>
                  </tr>
                  <tr>
                    <td>Indirizzo</td>
                    <td><input maxlength="16" size="25" name="username11" /></td>
                  </tr>
                  <tr>
                    <td>CAP</td>
                    <td><input maxlength="16" size="25" name="username12" /></td>
                  </tr>
                  <tr>
                    <td>Citta</td>
                    <td><input maxlength="16" size="25" name="username13" /></td>
                  </tr>
                  <tr>
                    <td>Provincia</td>
                  ...
                  <tr>
                    <td>Nazione</td>
                    <td><input maxlength="16" size="25" name="username132" /></td>
                  </tr>
                  <tr>
