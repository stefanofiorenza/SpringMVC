...
@RestController
@RequestMapping(value = "/api/exams/learn")
@Slf4j
public class LearningExamController {
	...
	public ExamDto startCertificationExam(
		...
		log.info("Authenticate userKey: {}. Found: TestUser",userKey);				
		return examService.createQuiz(examCode,"TestUser", ExamMode.LEARNING);			
	}
